  ...
  ja: {
    ...
    token: {
      ...
      cards: [
        ...
        { icon:"🎉", label:"輪が閉じる",       value:"100 / 50",   note:"起点者100・他50。これにステージ倍率がかかる", accent:"#ffcc00" },
  ...
  en: {
    ...
    token: {
      ...
      cards: [
        ...
        { icon:"🎉", label:"Close a loop",         value:"100 / 50",  note:"100 for the origin, 50 for others — times the stage multiplier", accent:"#ffcc00" },
