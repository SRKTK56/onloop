...
const t = {
  ja: {
    ...
    token: {
      ...
      cards: [
        ...
        { icon:"🌏", label:"連鎖が長いほど",   value:"最大×5",    note:"完成ぶんにステージ倍率がかかる", accent:"#5c4ade" },
      ],
  ...
  en: {
    ...
    hero: {
      ...
      v2:     "A system that records kindness chains semi-permanently",
    ...
    token: {
      ...
      cards: [
        ...
        { icon:"🌏", label:"The longer the chain", value:"up to ×5",  note:"Stage multiplier on the loop bonus", accent:"#5c4ade" },
      ],
